...
void Cube::ConstructionAvion() {
	...
	osg::ref_ptr<osg::Node> avionAmi(osgDB::readNodeFile(CHEMIN_MODELES+"Avion.3ds"));
	osg::ref_ptr<osg::Node> avionEnnemi(osgDB::readNodeFile(CHEMIN_MODELES+"TIE-fighter.3ds"));
...
/* TERRAIN */
	...
	osg::ref_ptr<osg::Node> terrainNode (osgDB::readNodeFile(CHEMIN_MODELES+"terrain3.3ds"));
